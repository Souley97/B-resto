...
export default function MenuManagement() {
  ...
  return (
    <div className="container mx-auto p-4">
      <Card className="rounded-3xl justify-between bg-gradient-to-r p-8 mr-6 bg-white/50 backdrop-blur-xl  border-white border-2 shadow-xl transition-all duration-300"  >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <Input type="text" placeholder="New Extra" value={newExtra} onChange={(e) => setNewExtra(e.target.value)} />
            <Button type="button" onClick={addExtra} className="bg-gradient-to-r from-indigo-400 via-blue-500 to-purple-500 text-white">
              Add Extra
            </Button>
          </div>
        </div>
        ...
        <Button
         className="bg-gradient-to-r from-indigo-400 via-blue-500 to-purple-500 text-white"
        type="submit">{editingItem ? "Update Item" : "Add Item"}</Button>
        {editingItem && (
          <Button
          
          
          type="button" onClick={() => setEditingItem(null)} variant="outline">
            Cancel Edit
          </Button>
        )}
      </form>
          ...
          <TableBody>
            {menuItems.map((item) => (
              ...
              className="bg-gradient-to-r from-red-400 via-red-500 to-red-400 text-white"
                  ...
                  onClick={() => deleteMenuItem(item.id)} variant="destructive">
                    Delete
                  </Button>
                </TableCell>
              </TableRow>
