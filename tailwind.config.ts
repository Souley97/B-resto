  	...
  	extend: {
		backgroundImage: {
  		...
  		keyframes: {
			  ...
			  'borderLoop': {
				'0%': { borderColor: 'rgba(249, 115, 22, 0.3)' }, // Couleur initiale
				'50%': { borderColor: 'rgba(249, 115, 22, 1)' },  // Milieu intense
				'100%': { borderColor: 'rgba(249, 115, 22, 0.3)' }, // Retour
			  },
  		},
  		animation: {
  			'accordion-down': 'accordion-down 0.2s ease-out',
  			'accordion-up': 'accordion-up 0.2s ease-out',
			  'border-loop': 'borderLoop 3s infinite', // Animation en boucle
